...
- (id)initWithDictionary:(NSDictionary *)dictionary {
	...
	_isInMatrix = [dictionary[@"isInMatrix"] boolValue];
	_isMatrixTextOnly = [dictionary[@"isMatrixTextOnly"] boolValue];
	_isPersonalizable = [dictionary[@"isPersonalizable"] boolValue];
	...
	_matrixId = [dictionary[@"matrixId"] integerValue];
...
- (id)initWithCoder:(NSCoder *)coder {
	...
	_matrixId = [coder decodeIntegerForKey:@"matrixId"];
	_isPersonalizable = [coder decodeBoolForKey:@"isPersonalizable"];
	...
	_isInMatrix = [coder decodeBoolForKey:@"isInMatrix"];
	...
	_isMatrixTextOnly = [coder decodeBoolForKey:@"isMatrixTextOnly"];
